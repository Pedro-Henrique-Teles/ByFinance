<div x-show="openModal === 'modalReceita'" x-transition class="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
    <div class="bg-white p-6 rounded-lg w-1/2 relative">
        ...
        <h2 class="text-xl font-semibold text-gray-900">Novo Lançamento - Receita</h2>
        ...
        <form>
            ...
            <div class="mt-4 flex justify-between">
                ...
                <button type="submit" class="px-4 py-2 bg-green-600 text-white rounded-md">Salvar Receita</button>
            </div>
        </form>
    </div>
</div>
